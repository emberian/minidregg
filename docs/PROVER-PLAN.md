...
| Ext6 gate proof | exact seven-operand descriptor algebra and eta relation | canonical prefix-decodable statement preimage, codecs/cSHAKE transcript, full algebraic checker | eight-event conditional ledger separates challenge sampling from ROM | absent from base/deployment | none | PCS, subfield, proximity, binding, ROM, sampling-bias price, final LDT, global game, recursion |
