...
/-- info: 'Minidregg.Selvage.workHybridStep_ok_or_constructionMismatch_of_need_le' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs (whitespace := lax) in
#print axioms workHybridStep_ok_or_constructionMismatch_of_need_le
