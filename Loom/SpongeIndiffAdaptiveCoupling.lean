/-
# Loom.SpongeIndiffAdaptiveCoupling — prefix-measurable coin reindexing
...
-/
import Loom.SpongeIndiffDeferredWork
...
/-- info: 'Minidregg.Loom.uniformProb_guarded_reindex' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs (whitespace := lax) in #print axioms uniformProb_guarded_reindex
/-- info: 'Minidregg.Loom.SpongeAdaptiveCouplingExample.adaptiveTailEvent_probability' depends on axioms: [propext, Classical.choice, Quot.sound] -/
