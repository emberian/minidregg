/-
# Loom.SpongeIndiffRunInvariant — fold the sponge simulator invariant over a run

`Loom.SpongeIndiff` proves that one forward or inverse simulator step preserves
...
/-- info: 'Minidregg.Loom.idealRun_uniquePaths_of_fresh' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs (whitespace := lax) in #print axioms idealRun_uniquePaths_of_fresh
/-- info: 'Minidregg.Loom.SpongeRunInvariantExample.forwardOne_uniquePaths' depends on axioms: [propext, Classical.choice, Quot.sound] -/
