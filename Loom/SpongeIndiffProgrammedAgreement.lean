/-
# Loom.SpongeIndiffProgrammedAgreement — the temporal programming boundary
...
-/
import Loom.SpongeIndiffOffBadRun
...
/-- info: 'Minidregg.Loom.simFwdRO_programs_previously_answered' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs (whitespace := lax) in
#print axioms simFwdRO_programs_previously_answered
/-- info: 'Minidregg.Loom.SpongeProgrammedAgreementExample.construction_first_not_every_answer_programmed' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs (whitespace := lax) in
#print axioms SpongeProgrammedAgreementExample.construction_first_not_every_answer_programmed
/-- info: 'Minidregg.Loom.SpongeProgrammedAgreementExample.construction_first_later_programmed' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs (whitespace := lax) in
