/-
# Loom.HalfThresholdFriTranscript -- committed FRI words and opened queries

`Loom.HalfThresholdFriTower` proves challenge soundness for the DERIVED fold
...
-/
import Loom.HalfThresholdFriTower
