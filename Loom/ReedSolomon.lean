/-
# Loom.ReedSolomon — the RS instantiation: WHIR Corollary 4.11's unique-decoding shape.

Instantiates the PROVED generic theorem
`hasMutualCorrelatedAgreement_of_isProximityGenerator` (Loom/CorrelatedAgreement.lean,
