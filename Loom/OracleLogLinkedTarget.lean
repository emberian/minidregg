/-
# Loom.OracleLogLinkedTarget — repair the final deployed-ZK target before
proving it

`Loom.OracleLogLinked` leaves a prose residual: build an `OracleLogReduction`
