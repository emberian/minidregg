/-
# Loom.HalfThresholdFri -- the first FRI round at one halved threshold

`Loom.HalfThresholdRegime` proves the characteristic-independent algebraic
...
code.  This file connects that statement to Loom's concrete multiplicative
FRI fold.
...
-/
import Loom.HalfThresholdRegime
...
its once-halved threshold `3/20` lies inside Loom's UNCONDITIONAL
...
For later rounds Loom currently offers two genuine choices:
