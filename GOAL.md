...
Weaving: LightClientSound ([LC-sound] — the tower keystone), Proximity (WHIR/FRI low-degree test — the linchpin unlocking [DEC-proximity]/[OB3-c-prox]/[ACC-sound-list]).
