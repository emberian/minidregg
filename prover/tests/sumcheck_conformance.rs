...
use minidregg_prover::descriptor::Fp;
use minidregg_prover::poseidon::BABY_BEAR_P;
use minidregg_prover::sumcheck::{
    eval_affine, mle_eval, prove_sumcheck, round_poly, round_sum, verify_sumcheck,
};
...
fn conformance() -> ConformanceFile {
    ...
    assert_eq!(c.p, BABY_BEAR_P, "the vector is over the prover's field");
...
/// the MLE oracle; tampering any round message or the claim fails.
#[test]
